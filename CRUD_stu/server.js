...
const server = http.createServer(async (req, res) => {
    ...
    let students = await getStudentsFromFile(); // Initialize students before using it

    if (method === "GET" && url === "/getStudents") {
        return res.end(JSON.stringify({ message: "Data successfully fetched", data: students }));
    }
